...
#define STRING_CONFIG_H_AUTHOR "(Scrub's attempt, Ender 3 chasis Skr Mini E3 V.2.0 Semitec bl touch)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_V2_0
#endif

// Name displayed in the LCD "Ready" message and Info menu
#define CUSTOM_MACHINE_NAME "Pain_In_The_Ass"
